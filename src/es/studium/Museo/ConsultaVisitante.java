...
public class ConsultaVisitante implements WindowListener, ActionListener {

    Frame ventana = new Frame("Consulta de Visitantes");
    ...
    public ConsultaVisitante() {
        ...
        txtArea.append(modelo.consultarVisitantes(connection));
